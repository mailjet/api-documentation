...
{{contact_managecontactslists_POST_response_STATIC}}
...
{{contact_managemanycontactsJob_GET_STATIC}}
...
{{contactslist_ManageManyContacts_POST}}
...
{{contactslist_ManageManyContactsJob_GET_STATIC}}
...
{{csvimportJob_GET_STATIC_response}}
